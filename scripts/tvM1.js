const imagePairs = [
    { src: 'images/shawn.jpg', matchId: 'HG' },
    { src: 'images/gus.jpg', matchId: 'HG' },
    { src: 'images/hutch.jpg', matchId: 'DB' },
    { src: 'images/star.jpg', matchId: 'DB' },
    { src: 'images/chan.jpg', matchId: 'HP' },
    { src: 'images/joey.jpg', matchId: 'HP' },
    { src: 'images/el.jpg', matchId: 'MR' },
    { src: 'images/bonnie.jpg', matchId: 'MR' },
    { src: 'images/kirk.jpg', matchId: 'TM' },
    { src: 'images/spock.jpg', matchId: 'TM' },
    { src: 'images/dean.jpg', matchId: 'LW' },
    { src: 'images/sam.jpg', matchId: 'LW' },
];
...
nextLevelBtn.addEventListener('click', () => {
    window.location.href = 'tvM2.html';
});
