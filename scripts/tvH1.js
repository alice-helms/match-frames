const imagePairs = [
    { src: 'images/meth.jpg', matchId: 'HG' },
    { src: 'images/walter.jpg', matchId: 'HG' },
    { src: 'images/baseball.jpg', matchId: 'DB' },
    { src: 'images/negan.jpg', matchId: 'DB' },
    { src: 'images/pen.jpg', matchId: 'HP' },
    { src: 'images/percy.jpg', matchId: 'HP' },
    { src: 'images/joe.jpg', matchId: 'MR' },
    { src: 'images/box.jpg', matchId: 'MR' },
    { src: 'images/rami.jpg', matchId: 'TM' },
    { src: 'images/computer.jpg', matchId: 'TM' },
    { src: 'images/cig.jpg', matchId: 'LW' },
    { src: 'images/tommy.jpg', matchId: 'LW' },
];
...
nextLevelBtn.addEventListener('click', () => {
    window.location.href = 'tvH2.html';
});
