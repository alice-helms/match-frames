const imagePairs = [
    { src: 'images/maxx.jpg', matchId: 'HG' },
    { src: 'images/maxx2.jpg', matchId: 'HG' },
    { src: 'images/flix.jpg', matchId: 'DB' },
    { src: 'images/flix2.jpg', matchId: 'DB' },
    { src: 'images/obi.jpg', matchId: 'HP' },
    { src: 'images/wanda.jpg', matchId: 'HP' },
    { src: 'images/normal.jpg', matchId: 'MR' },
    { src: 'images/thebear.jpg', matchId: 'MR' },
    { src: 'images/reacher.jpg', matchId: 'TM' },
    { src: 'images/summer.jpg', matchId: 'TM' },
    { src: 'images/jackal.jpg', matchId: 'LW' },
    { src: 'images/dexter.jpg', matchId: 'LW' },
];
...
nextLevelBtn.addEventListener('click', () => {
    window.location.href = 'tvH1.html';
});
